...
PUBLIC_PETSCII_CSS="ios/App/App/public/petscii.css"
...
verify_native_bundle() {
  ...
  [[ -f www/petscii.css ]] || fail "www/petscii.css was not generated."
  grep -q 'name="ios-native-build" content="83"' www/index.html || fail "Generated www bundle is not native build 83."
  ...
  grep -q 'ios-info.js?v=83' www/index.html || fail "Native privacy behavior is not linked."
  ...
  [[ -f "$PUBLIC_PETSCII_CSS" ]] || fail "$PUBLIC_PETSCII_CSS was not copied by Capacitor."
  [[ -f ios/App/App/public/privacy.html ]] || fail "Xcode public bundle is missing privacy.html."
  grep -q 'name="ios-native-build" content="83"' "$PUBLIC_INDEX" || fail "Xcode public bundle is stale; expected native build 83."
  ...
  say "Native bundle verification: OK (build 83)"
}
